...
exports.MockGeoProvider = void 0;
const SPEED_KMH = 35;
...
class MockGeoProvider {
    ...
    async autocomplete(query, limit = 5) {
        ...
        return MOCK_PLACES.filter((place) => {
            return (place.label.toLowerCase().includes(normalized) ||
